...
class AbductionAgent:
    ...
    def __init__(
        ...
        *,
        ...
        llm_call_async: Optional[Callable[[str], Any]] = None,
    ...
    async def abduce(
        ...
        reasoning_trace.append(ReasoningStep(
            ...
            output_data={
                h.id: h.composite_score for h in evaluated
            }
        ))
    ...
    async def single_shot(
        ...
        for h_data in data.get("hypotheses", []):
            ...
            hypotheses.append(Hypothesis(
                ...
                assumptions=[
                    Assumption(statement=a) for a in h_data.get("assumptions", [])
                ],
    ...
    async def _analyze_observation(
        ...
        return Observation(
            ...
            surprise_level=surprise_map.get(
                data.get("surprise_level", "surprising"),
                SurpriseLevel.SURPRISING
            ),
    ...
    async def _run_council(
        ...
        tasks = [
            self._run_critic(critic, observation, hypotheses)
