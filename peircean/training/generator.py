    ...
    Domain.FINANCIAL: [
        {
            ...
            "context": {"surprise_reason": "Positive earnings typically correlate with price increases"},
            "hypotheses": [
                {
    ...
    Domain.TECHNICAL: [
        {
            ...
            "context": {"surprise_reason": "Lower CPU should mean more capacity, not worse performance"},
            "hypotheses": [
                {
                ...
                },
                {
                    ...
                    "prior_probability": 0.30,
                    "assumptions": ["HPA configured for CPU", "Scale-down threshold too aggressive"]
                },
                {
...
class AbductiveDataGenerator:
    ...
    def generate_example(self, domain: Domain) -> AbductiveExample:
        ...
        return AbductiveExample(
            ...
            recommended_actions=[
                f"Verify assumption: {best_hypothesis['assumptions'][0]}" if best_hypothesis.get("assumptions") else "Gather more data",
